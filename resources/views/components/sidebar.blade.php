    ...
    <ul class="metismenu" id="menu">
        ...
        @if (hasRoles(['admin', 'manager', 'salesman']))
            <li>
                ...
                <ul>
                    ...
                    @if (hasRoles(['admin', 'manager']))
                        ...
                        <li><a href="{{ route('warehouses.index') }}"><i class="lni lni-dropbox-original"></i>Склады</a>
                        </li>
                    @endif
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ route('sales.installment') }}"><i class="bx bx-plus"></i> Добавить рассрочку</a>
                    </li>
                    <li><a href="{{ route('installments.debt') }}"><i class="bx bx-list-plus"></i> Рассрочки по
                            долгам</a></li>
        ...
        @if (hasRoles(['admin']))
            <li>
                ...
                <ul>
                    <li><a href="{{ route('transfers.index') }}"><i class="lni lni-dropbox-original"></i> Список
                            перемещений</a></li>
                    <li><a href="{{ route('transfers.create') }}"><i class="lni lni-dropbox-original"></i> Добавить
                            перемещение</a></li>
                </ul>
            </li>
            <li>
                ...
                <ul>
                    ...
                    <li><a href="{{ route('reports.installment-report-debt') }}"><i class="bx bx-chart"></i>
                            Рассрочки</a></li>
                    <li><a href="{{ route('reports.customer-report') }}"><i class="bx bx-chart"></i> Клиенты</a></li>
                    <li><a href="{{ route('reports.customer-find-report') }}"><i class="bx bx-chart"></i> Источники
                            клиентов</a></li>
                    <li><a href="{{ route('reports.product-report-sale') }}"><i class="bx bx-chart"></i> Продукты</a>
                    </li>
                    <li><a href="{{ route('reports.product-report-alert-quantity') }}"><i class="bx bx-chart"></i>
                            Уведомление кол-ва</a></li>
                    <li><a href="{{ route('reports.product-report-frozen') }}"><i class="bx bx-chart"></i>
                            Замороженные продукты</a></li>
                    <li><a href="{{ route('reports.product-report-top-sale') }}"><i class="bx bx-chart"></i> Топ
                            продаж</a></li>
                    <li><a href="{{ route('reports.expense') }}"><i class="bx bx-chart"></i> Расходы</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul>
                    <li><a href="{{ route('payment-methods.index') }}"><i class="bx bx-list-plus"></i> Способы
                            оплаты</a></li>
                    <li><a href="{{ route('finds.index') }}"><i class="bx bx-list-plus"></i> Источники</a></li>
                    <li><a href="{{ route('installment-months.index') }}"><i class="bx bx-list-plus"></i> Рассрочки
                            месяцы</a></li>
                </ul>
            </li>
        @endif
