...
<div class="row">
    ...
    {{ Form::model($user, ['route' => ['users.update', $user->id], 'method' => 'PUT', 'class' => 'row', 'files' => true]) }}
    <div class="col-4">
        <div class="card">
    ...
    <div class="col-8">
        <div class="card">
            ...
            <div class="card-body row g-2">
                ...
                <div class="col-12">
                    {{ Form::button('<i class="bx bx-save"></i> Сохранить', ['type' => 'submit', 'class' => 'btn btn-primary']) }}
                </div>
            </div>
        </div>
    </div>
