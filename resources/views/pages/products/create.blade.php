                    ...
                    <div class="col-12">
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="input-group">
                                    <input type="text" name="installment_price_usd" id="installment_price_usd" class="form-control money" required value="{{ old('installment_price_usd') }}">
                                    <span class="input-group-text"><i class="bx bx-dollar"></i></span>
                                    <input type="text" name="installment_price" id="installment_price" class="form-control money" value="{{ old('installment_price') }}">
                                    <span class="input-group-text">UZS</i></span>
                                </div>
                            </div>
                        </div>
